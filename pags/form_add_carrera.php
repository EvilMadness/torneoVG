...
<div class="wrapper row3 bgded overlay2 fondoformulario">
    <main class="hoc container clear">
        <div id="comments" align="center">
            <form enctype="multipart/form-data" action="process/add_carrera.php" method="POST" style="width: 70%" onsubmit="return validarcarrera();">
                ...
                <div class="one_quarter first">
                    ...
                    <input class="" id="id_carrera" name="id_carrera" type="number" placeholder="ID de la carrera" onkeyup="verificar_id()">
                    <label id="id_exist"></label>
                </div>
                <div class="three_quarter    form-group">
                    <label for="nom_carrera"><b>Nombre de la carrera</b><span>*</span></label>
                    <input class="" id="nom_carrera" name="nom_carrera" type="text" placeholder="Licenciatura, Ingenieria o Nivelación." >
                </div>
                <div class="center first" >
                    <input type="submit" name="submit" value="Registrar carrera">
                </div>
            </form>
        </div>
    </main>
