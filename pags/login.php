        ...
        <div id="comments" align="center">
            <form enctype="multipart/form-data" action="sesion.php" method="POST" style="width: 50%">
                ...
                <div>
                    ...
                    <input name="nickname" id="nickname" type="text" placeholder="Nombre de usuario" required>
                </div>
                <div>
                ...
                <div>
                    <span class="fondoLink"><a class="fondoLink" href="form_registro.php">¿Aún no tienes una cuenta? ¡Registrate aquí!</a></span>
                </div>
            </form>
        </div>
    </main>
