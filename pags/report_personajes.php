...
<head>
    <meta charset="UTF-8">
    <title>Reporte Personajes</title>
...
<script>
    function confirmDelete(user) {
        if (confirm("¿Estas seguro de eliminar al personaje "+user+"?")==true){
            return true;
        }else
            return false;
    }
...
<div class="wrapper row1">
    ...
    <div class="wrapper row3 bgded overlay2 fondoformulario">
        <main class="hoc container clear">
            <div id="comments">
                <div align="center">
                    <h2 class="healset2">Lista de personajes</h2>
                    <input type="submit" onclick="location.href='form_add_personaje.php';" value="Registrar otro personaje" >
                    <table class="tablapos" border="1" width="80%" style="background-color: #469599" id="result">
                        ...
                        foreach ($datos as $dato){
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <a href="form_edit_personaje.php?id=<?php echo $dato['idPersonaje'];?>"><img src="../images/icon/Edit.png"></a>
                                    <a href="process/remove_personaje.php?id=<?php echo $dato['idPersonaje'];?>"onclick="return confirmDelete('<?php echo $dato['nombre'];?>')"><img src="../images/icon/delete.png"></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
