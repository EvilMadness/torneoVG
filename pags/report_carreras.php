...
<script>
    function confirmDelete(user) {
        if (confirm("¿Estas seguro de eliminar la carrera "+user+"?")==true){
            return true;
        }else
            return false;
    }
...
<div class="wrapper row1">
    ...
    <div class="wrapper row3 bgded overlay2 fondoformulario">
        <main class="hoc container clear">
            <div id="comments">
                <div align="center">
                    <h2 class="healset2">Lista de carreras</h2>
                    <table class="tablapos" border="1" width="50%" style="background-color: #469599" id="result">
                        <tr>
                        ...
                        foreach ($datos as $dato){
                            ?>
                            <tr align="center">
                                <td><?php echo utf8_encode($dato['nombre_carrera']);?></td>
                                <td>
                                    <a href="form_edit_carrera.php?id=<?php echo $dato['idCarrera'];?>"><img src="../images/icon/Edit.png"></a>
                                    <a href="process/remove_carrera.php?id=<?php echo $dato['idCarrera'];?>"onclick="return confirmDelete('<?php echo utf8_encode($dato['nombre_carrera']);?>')"><img src="../images/icon/delete.png"></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
                ...
                <div class="center">
                    <input type="submit" onclick="location.href='form_add_carrera.php';" value="Registrar otra carrera" >
                </div>
            </div>
        </main>
    </div>
